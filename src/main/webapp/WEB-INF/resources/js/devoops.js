...
function LoadBootstrapValidatorScript(callback) {
	if (!$.fn.bootstrapValidator) {
		$
				.getScript(
						'resources/plugins/bootstrapvalidator/bootstrapValidator.min.js',
						callback);
	} else {
		if (callback && typeof (callback) === "function") {
			callback();
		...
		$
				.getScript(
						...
						function() {
							$
									.getScript(
											'resources/plugins/datatables/ZeroClipboard.min.js',
											function() {
												$
														.getScript(
																'resources/plugins/datatables/dataTables.tableTools.min.js',
																function() {
																	$
																			.getScript(
...
function LoadSpringyScripts(callback) {
	function LoadSpringyScript() {
		$
				.getScript('resources/plugins/springy/springy.js',
						LoadSpringyUIScript);
	}
