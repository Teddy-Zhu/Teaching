                    ...
                    <div id="collapseForsupplierTable" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingTwo">
                        <div class="panel-body" style="overflow-x: hidden; overflow-y: hidden; width: 100%">
                            <div class="searchClass row">
                                <div class="col-xs-12">
                                    <label>CourseName</label><input class="SearchForm form-control" type="text" id="CourseName"/> <label>CourseType</label><select class="SearchForm form-control" id="CourseType">
                                    <option value="-1">All Type</option>
                                </select> <label>Class</label><input class="SearchForm form-control"
                                                                     type="text" id="ClassId"/> <label>BookName</label><input class="SearchForm form-control" type="text" id="BookName"/>
                                </div>
                                <div class="col-xs-12">
                                    <label>Plan Status</label><select class="SearchForm form-control" id="PlanStatus">
                                    <option value="-1">All Status</option>
                                </select> <label>From</label><input class="SearchForm form-control" type="text" id="FromYear"/> <label>To</label><input class="SearchForm form-control" type="text"
                                                                                                                                                        id="ToYear"/> <label>Term</label><select class="SearchForm form-control" id="Term">
                                ...
                                <div class="col-xs-12">
                                    <label>StudentCount</label><input class="SearchForm form-control" type="text" id="StuCount"/> <label>TeacherCount</label><input class="SearchForm form-control" type="text" id="TeaCount"/>
                                    <label>Date</label><input class="SearchForm form-control" type="text" id="SearchDate" ReadOnly/> <label>User</label>
