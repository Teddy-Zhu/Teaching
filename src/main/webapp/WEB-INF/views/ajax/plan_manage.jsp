							...
							<div class="panel-body" style="overflow-x: hidden; overflow-y: hidden; width: 100%">
								<div class="searchClass row">
									<div class="col-xs-12">
										...
										</select> <label>Class</label><input class="SearchForm form-control" type="text" id="ClassId" /> <label>BookName</label><input class="SearchForm form-control" type="text" id="BookName" />
									</div>
									<div class="col-xs-12">
										<label>Plan Status</label><select class="SearchForm form-control" id="PlanStatus">
											<option value="-1">All Status</option>
										</select> <label>From</label><input class="SearchForm form-control" type="text" id="FromYear" /> <label>To</label><input class="SearchForm form-control" type="text" id="ToYear" /> <label>Term</label><select class="SearchForm form-control" id="Term">
