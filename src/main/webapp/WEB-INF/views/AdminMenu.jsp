                    ...
                    <div class="col-xs-4 col-sm-8 top-panel-right">
                        <ul class="nav navbar-nav pull-right panel-menu">
                            ...
                            <li class="dropdown"><a href="#" class="dropdown-toggle account"
                                    ...
                                    src="${user.strpic}<c:if test="${empty user}">resources/img/userpic/avatar.jpg</c:if>"
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="javascript:LoadAjaxContent('ajax/personinfo_manage')"> <i
                                            class="fa fa-user"></i> <span>Profile</span>
                                    </a></li>
                                    <li><a href="javascript:LoadAjaxContent('ajax/personal_setting')"> <i
                                            class="fa fa-cog"></i> <span>Settings</span>
                                    </a></li>
                                    <li><a href="javascript:logout();"> <i class="fa fa-power-off"></i>
                                        <span>Logout</span>
                                    </a></li>
                                </ul>
                            </li>
...
<div id="main" class="container-fluid">
    <div class="row">
        <div id="sidebar-left"
             class="col-xs-2 col-sm-2<c:if test="${openAnimation eq 1}"> am-animation-slide-left</c:if>">
            <ul class="nav main-menu">
                <li><a href="dashboard" class="ajax-link"> <i class="fa fa-dashboard"></i> <span class="hidden-xs">Dashboard</span>
                </a></li>

                <li class="dropdown"><a href="#" class="dropdown-toggle"> <i class="fa fa-book"></i> <span
                        class="hidden-xs">Books</span>
                </a>
                    <ul class="dropdown-menu">
                        <c:if test="${managebook eq true}">
                            <li><a class="ajax-link" href="book_manage"><i class="fa fa-clipboard"></i> Book Manage</a>
                            </li>
                        </c:if>
                        <c:if test="${managesupplier eq true}">
                            <li><a class="ajax-link" href="supplier_manage"><i class="fa fa-pied-piper"></i> Supplier
                                Manage</a></li>
                        </c:if>
                    </ul>
                </li>
                <c:if test="${planui eq true}">
                    <li class="dropdown"><a href="#" class="dropdown-toggle"> <i class="fa fa-book"></i> <span
                            class="hidden-xs">Plans</span>
                    </a>
                        <ul class="dropdown-menu">
                            <c:if test="${submitplan eq true}">
                                <li><a class="ajax-link" href="plan_submit"><i class="fa fa-paper-plane-o"></i> Plan
                                    Submit</a></li>
                            </c:if>
                            <c:if test="${queryplan eq true}">
                                <li><a class="ajax-link" href="plan_query"><i class="fa fa-file-archive-o"></i> Plan
                                    Query</a></li>
                            </c:if>
                ...
                <c:if test="${manageuser eq true}">
                    <li class="dropdown"><a href="#" class="dropdown-toggle"> <i class="fa fa-suitcase"></i> <span
                            class="hidden-xs">User Manage</span>
                    </a>
                        <ul class="dropdown-menu">
                            <li><a class="ajax-link" href="userinfo_manage"><i class="fa fa-book"></i> User Manage</a>
                            </li>
                        </ul>
                    </li>
                </c:if>
                <li class="dropdown"><a href="#" class="dropdown-toggle"> <i class="fa fa-user"></i> <span
                        class="hidden-xs">Person Setting</span>
                </a>
                    <ul class="dropdown-menu">
                        <li><a class="ajax-link" href="personinfo_manage"><i class="fa fa-clipboard"></i> Info
                            Manage</a></li>
                        <li><a class="ajax-link" href="personal_setting"><i class="fa fa-clipboard"></i> Setting Manage</a>
                        </li>
                    </ul>
                </li>
                <c:if test="${setting eq true}">
                    <li class="dropdown"><a href="#" class="dropdown-toggle"> <i class="fa fa-cog"></i> <span
                            class="hidden-xs">System Settings</span>
                    </a>
                        <ul class="dropdown-menu">
                            <c:if test="${manageuserdepart eq true}">
                                <li><a class="ajax-link" href="department_manage"><i class="fa fa-clipboard"></i> Depart
                                    Manage</a></li>
                            </c:if>
                            <c:if test="${manageusertype eq true or managebooktype eq true}">
                                <li><a class="ajax-link" href="type_manage"><i class="fa fa-clipboard"></i> Type Manage</a>
                                </li>
                            </c:if>
                ...
                <li class="dropdown"><a href="javascript:logout();" class="dropdown-toggle"> <i
                        class="fa fa-sign-out"></i> <span class="hidden-xs">Log Out</span>
                </a></li>
            </ul>
        </div>
        <!--Start Content-->
