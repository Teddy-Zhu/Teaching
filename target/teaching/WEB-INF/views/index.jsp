                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body text-center">
                                ...
                                <br>
                                <div class="input-group col-md-7 col-sm-offset-2">
                                    <span class="input-group-addon" style="width: 100px; text-align: left;"><span class="glyphicon glyphicon-lock">Password</span></span> <input id="loginPassWord" type="password" class="form-control" placeholder="Password"><span class="passwordc input-group-addon glyphicon glyphicon-eye-close"
                                                                                                                                                                                                        style="top: 0px"></span>
                                </div>
                                <br>
                                <div class="input-group col-md-7 col-sm-offset-2">
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body text-center">
                                ...
                                <br>
                                <div class="input-group col-md-7 col-sm-offset-2">
                                    <span class="input-group-addon" style="width: 100px; text-align: left;"><span class="glyphicon glyphicon-lock">Password</span></span> <input id="PassWord" type="password" class="form-control" placeholder="Password"><span class="passwordc input-group-addon glyphicon glyphicon-eye-close"
                                                                                                                                                                                                        style="top: 0px"></span>
                                </div>
                                <br>
                                <div class="input-group col-md-7 col-sm-offset-2">
                                    <span class="input-group-addon" style="width: 100px; text-align: left;"><span class="glyphicon glyphicon-lock"> Re-Pass</span></span> <input id="RePassWord" type="password" class="form-control" placeholder="Re-Password"><span class="passwordc input-group-addon glyphicon glyphicon-eye-close"
                                                                                                                                                                                                        style="top: 0px"></span>
                                </div>
                                <br>
                                <div class="input-group col-md-7 col-sm-offset-2">
