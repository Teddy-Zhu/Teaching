	...
	<div class="col-xs-12">
		<div class="box">
			<div class="box-header">
				<div class="box-name">
					<i class="fa fa-table"></i> <span>Beauty Tables (Inputs in cell+Keyboard navigation)</span>
				</div>
				<div class="box-icons">
					<a class="beauty-table-to-json"> Table to JSON </a> <a class="collapse-link"> <i class="fa fa-chevron-up"></i>
...
<div class="row">
	<div class="col-xs-12">
		<div class="box">
			<div class="box-header">
				<div class="box-name">
					<i class="fa fa-table"></i> <span>Beauty Tables (Inputs in cell+Keyboard navigation)+String Fill</span>
				</div>
				<div class="box-icons">
					<a class="beauty-table-to-json"> Table to JSON </a> <a class="collapse-link"> <i class="fa fa-chevron-up"></i>
					</a> <a class="expand-link"> <i class="fa fa-expand"></i>
			...
			<div class="box-content">
				...
				<ol>
					...
					<li><kbd>PgUp/PgDown</kbd>-First(End) cell in table</li>
					<li><kbd>Enter/Tab</kbd>-Next cell in table</li>
					<li>check <code>String Fill</code> checkbox and after entering in cell- next cell filled same value
					</li>
					<li>Press link Table to JSON in box header and see result</li>
				</ol>
				<p>
